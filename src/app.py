...
class ServiceContainer:
    def __init__(self, config=None):
        ...
        self.agent_loop: LiteGraphAgentLoop | None = None
    ...
    async def setup(self):
        ...
        self.agent_loop = LiteGraphAgentLoop(
            client=client,
            tools=tools,
        ...
        logger.info("LiteGraphAgentLoop created with %d tools, %d skills", len(tools), len(skills))

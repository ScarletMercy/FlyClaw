...
THREAT_PATTERNS = [
    ...
    (
        r"\$HOME/\.flyclaw\d*/\.env|\~/\.flyclaw\d*/\.env",
        "agent_env_access",
        "critical",
        "exfiltration",
    ...
    (r"\.\./\.\.", "path_traversal", "low", "traversal", "relative path traversal (2+ levels up)"),
    ...
    (r"git\s+clone\s+", "git_clone", "low", "supply_chain", "clones a git repository at runtime"),
    ...
    (
        r"\.flyclaw\d*/config\.yaml|\.flyclaw\d*/SOUL\.md",
        "flyclaw_config_mod",
        "critical",
        "persistence",
